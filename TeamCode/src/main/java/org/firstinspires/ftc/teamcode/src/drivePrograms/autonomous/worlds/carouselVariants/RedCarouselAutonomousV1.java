...
@Deprecated
@Disabled
@Autonomous(name = "🟥Red Carousel Autonomous V1🟥", group = "RedCarousel")
public class RedCarouselAutonomousV1 extends WorldsAutonomousProgram {
    ...
    public RedCarouselAutonomousV1() {
    ...
    public void opModeMain() throws InterruptedException {
        ...
        final Trajectory toPark = RedCarouselAutonomousV1.ToEnd(drive, toSpinner.end());
